...
Model: Harveenchadha/vakyansh-wav2vec2-tamil-tam-250 (Tamil finetuned)
Pooling: attentive (attentive pooling only)
"""
...
def extract_features(model, feature_extractor, waveform, device, pooling_type="attentive"):

...
Pooling: average_attentive (both poolings)
Input dim: 2048
"""
...
def main():
    ...
    # Configuration
    INPUT_DIM = 1536  # 1536 for Tamil Wav2Vec average_attentive (768*2)
    BATCH_SIZE = 32
    NUM_EPOCHS = 256
    LEARNING_RATE = 1e-3
    WEIGHT_DECAY = 1e-4
    ...
    trainer = DialectClassificationTrainer(
        ...
        scheduler=scheduler,
        num_classes=4,
        log_path='./train_data/logs/training_2.log',
        num_epochs=NUM_EPOCHS,
        checkpoint_path='./train_data/checkpoints/train_2',
        graph_path='./train_data/graphs/metrics_2.png',
        verbose=True,
        device=device
    )

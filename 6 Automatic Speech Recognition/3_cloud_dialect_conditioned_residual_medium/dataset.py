...
class DialectConditionedASRDataset(Dataset):
    ...
    Converts absolute Windows paths to relative cloud paths.
    """
    ...
    def __init__(
        ...
        audio_base_path: str = None,  # If provided, replaces old path prefix with this
        ...
        Args:
            ...
            audio_base_path: Base path to replace original paths (for cloud training)
    ...
    def __getitem__(self, idx) -> Dict:
        ...
        # Convert Windows absolute path to cloud relative path
        # Old: E:/Work/My Papers/.../Final Dataset/Train/Central_Dialect/...
        # New: {audio_base_path}/Final Dataset/Train/Central_Dialect/...
        if self.audio_base_path is not None:
            # Extract the relative part starting from "Final Dataset"
            if "Final Dataset" in audio_path:
                relative_part = audio_path.split("Final Dataset", 1)[1]
                audio_path = f"{self.audio_base_path}/Final Dataset{relative_part}"

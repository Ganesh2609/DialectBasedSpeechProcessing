"""
Transcription Generator for Whisper Medium Models
...
def generate_transcriptions(
    ...
    output_path: str,
    csv_path: str,
    whisper_model: str = "vasista22/whisper-tamil-medium",
    dialect: str = None,
    num_samples: int = 100,
):
...
if __name__ == '__main__':
    ...
    generate_transcriptions(
        checkpoint_path=f"{BASE_PATH}/Final Whisper Training - Medium/Unified/train_data/checkpoints/best_model.pth",
        output_path=f"{BASE_PATH}/Final Whisper Training - Medium/Unified/train_data/transcriptions.csv",

"""
Training Script for Thanjavur Dialect - Whisper Medium
"""
...
def main():
    ...
    OUTPUT_PATH = f"{BASE_PATH}/Final Whisper Training - Medium/Thanjavur/train_data"
    ...
    print(f"\nStarting training ({DIALECT} dialect - Medium)...")
    trainer.train()

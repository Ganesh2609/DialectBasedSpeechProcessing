"""
Training Script for Unified Model (All Dialects) - Whisper Medium
"""
...
def main():
    ...
    OUTPUT_PATH = f"{BASE_PATH}/Final Whisper Training - Medium/Unified/train_data"
    ...
    print("\nStarting training (Unified - All Dialects - Medium)...")
    trainer.train()

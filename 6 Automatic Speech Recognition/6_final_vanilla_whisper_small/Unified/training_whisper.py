"""
Training Script for Unified Model (All Dialects) - Whisper Small
Uses WhisperForConditionalGeneration directly.
"""
...
def main():
    ...
    OUTPUT_PATH = f"{BASE_PATH}/Final Whisper Training - Small/Unified/train_data"
    
    WHISPER_MODEL = "vasista22/whisper-tamil-small"
    DIALECT = None  # All dialects
    ...
    # Load data
    print("Loading data (all dialects)...")
    ...
    trainer = ASRTrainer(
        ...
        scheduler=scheduler,
        processor=processor,
        log_path=f'{OUTPUT_PATH}/logs/training.log',
        num_epochs=NUM_EPOCHS,
        checkpoint_path=f'{OUTPUT_PATH}/checkpoints',
        graph_path=f'{OUTPUT_PATH}/graphs/training.png',
        verbose=True,
        device=device
    )
    
    print("\nStarting training (Unified - All Dialects)...")
    print("=" * 60)
    trainer.train()

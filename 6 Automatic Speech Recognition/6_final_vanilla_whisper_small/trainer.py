"""
Trainer for ASR Training

Greedy decoding during training/validation.
...
class ASRTrainer:
    ...
    def __init__(
        ...
        self.history = {
            'Training Loss': [], 'Training WER': [],
            'Validation Loss': [], 'Validation WER': [],
        }
        self.step_history = {
            'Training Loss': [], 'Training WER': [],
            'Validation Loss': [], 'Validation WER': [],
        ...
        with tqdm(enumerate(self.train_loader), total=len(self.train_loader), 
            ...
            for i, batch in t:
                ...
                with torch.no_grad():
                    ...
                    predictions = self.processor.tokenizer.batch_decode(predicted_ids, skip_special_tokens=True)

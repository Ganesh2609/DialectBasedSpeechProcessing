"""
Training Script for Dialect-Conditioned ASR (Whisper Small)

This script trains a dialect-conditioned Whisper-Small model on Tamil speech data.
...
def main():
    ...
    OUTPUT_PATH = f"{BASE_PATH}/ASR Whisper Small/train_data"
    
    # Model - Using Whisper Small instead of Medium
    ...
    print("=" * 60)
    # trainer.train()
    trainer.train(resume_from=f'{OUTPUT_PATH}/checkpoints/training 1/model_epoch_2.pth')

"""
Transcription Generator - Single Sample Inference (Cross-Attention)
...
def main():
    ...
    CHECKPOINT_PATH = f"{BASE_PATH}/ASR Whisper Small - Cross Attn/train_data/checkpoints/training 1/best_model.pth"
    OUTPUT_PATH = f"{BASE_PATH}/ASR Whisper Small - Cross Attn/train_data/transcriptions_comparison_1.csv"
